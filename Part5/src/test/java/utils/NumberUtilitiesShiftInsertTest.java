...
public class NumberUtilitiesShiftInsertTest {
    ...
    public void testShiftInsert_SortedArray_InsertAtStart() {
        ...
        boolean result = ArrayUtilities.shiftInsert(nums, val);
    ...
    @Test
    public void testShiftInsert_NullArray() {
        System.out.println("shiftInsert() testing with a null array");
        int[] nums = null;
        assertThrows(IllegalArgumentException.class,
            () -> {
                ArrayUtilities.shiftInsert(nums, 10);
            }
        );
    }
}
