...
public class NumberUtilitiesIsSortedDescTest {
    ...
    public void testIsSortedDesc_SortedArray_NoRun() {
        ...
        boolean result = ArrayUtilities.isSortedDesc(nums);
    ...
    @Test
    public void testIsSortedDesc_NullArray() {
        System.out.println("isSortedDesc() testing with a null array");
        int[] nums = null;
        assertThrows(IllegalArgumentException.class,
            () -> {
                ArrayUtilities.isSortedDesc(nums);
            }
        );
    }
}
