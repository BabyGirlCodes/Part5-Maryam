...
public class NumberUtilitiesResizeInsertTest {
    ...
    public void testResizeInsert_InsertAtStart() {
        ...
        int[] result = ArrayUtilities.resizeInsert(nums, val);
    ...
    @Test
    public void testResizeInsert_NullArray() {
        System.out.println("resizeInsert() testing with a null array");
        int[] nums = null;
        assertThrows(IllegalArgumentException.class,
            () -> {
                ArrayUtilities.resizeInsert(nums, 10);
            }
        );
    }
}
