...
/**
    ...
    public void testIsSortedAsc_SortedArray_NoRun() {
        ...
        boolean result = ArrayUtilities.isSortedAsc(nums);
    ...
    @Test
    public void testIsSortedAsc_NullArray() {
        System.out.println("isSortedAsc() testing with a null array");
        int[] nums = null;
        assertThrows(IllegalArgumentException.class,
            () -> {
                ArrayUtilities.isSortedAsc(nums);
            }
        );
    }
}
